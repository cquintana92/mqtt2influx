...
use serde::de::{value, DeserializeSeed, Deserializer, Error, IntoDeserializer, MapAccess, SeqAccess, Visitor};
    ...
    T: Deserialize<'de>,
{
        ...
        D: Deserializer<'de>,
    {
                ...
                while let Some(key) = map.next_key()? {
                    match key {
                        ...
                        Field::Values => {
                            ...
                            if columns.is_none() {
                                return Err(Error::custom("series values encountered before columns"));
                            }
        ...
        deserializer.deserialize_struct("Series", FIELDS, SeriesVisitor::<T> { _inner_type: PhantomData })
    }
}
    ...
    A: SeqAccess<'de>,
{
    ...
    fn next_key_seed<K: DeserializeSeed<'de>>(&mut self, seed: K) -> Result<Option<K::Value>, Self::Error> {
        ...
        self.field += 1;
        seed.deserialize(field.clone().into_deserializer()).map(Some)
    }
