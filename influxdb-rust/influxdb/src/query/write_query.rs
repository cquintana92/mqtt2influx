...
mod tests {
    ...
    fn test_write_builder_multiple_fields() {
        ...
        assert!(query.is_ok(), "Query was empty");
        assert_eq!(query.unwrap(), "weather temperature=82i,wind_strength=3.7 11");
    }
    ...
    fn test_write_builder_full_query() {
        ...
        assert!(query.is_ok(), "Query was empty");
        assert_eq!(query.unwrap(), r#"weather,location=us-midwest,season=summer temperature=82i 11"#);
    }
